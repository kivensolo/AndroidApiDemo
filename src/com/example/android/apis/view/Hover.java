...
public class Hover extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDescriptionTextView.setText(Html.fromHtml("演示如何使用\n" +
                "        <font color='#00FFFF' size='5'> <b>View.onHoverEvent</b>、\n" +
                "            <b>ViewGroup.onInterceptHoverEvent</b>  和\n" +
                "            <b>View.setOnHoverListener</b> </font>去处理鼠标光标事件。"));
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_HOVER_ENTER:   //鼠标进入View
                        mMessageTextView.setText(Hover.this.getResources().getString(
                                R.string.hover_message_entered_at,event.getX(), event.getY()));
                        break;
                    case MotionEvent.ACTION_HOVER_MOVE:    //鼠标在View上
                        mMessageTextView.setText(Hover.this.getResources().getString(
                                R.string.hover_message_moved_at,event.getX(), event.getY()));
                        break;
                    case MotionEvent.ACTION_HOVER_EXIT:    //鼠标离开View
                        mMessageTextView.setText(Hover.this.getResources().getString(
                                R.string.hover_message_exited_at,event.getX(), event.getY()));
                        break;
                }
                return false;
            }
